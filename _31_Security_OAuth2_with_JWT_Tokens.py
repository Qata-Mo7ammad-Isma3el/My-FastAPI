...
#// discarded lines
#!------------------ Theory ------------------!#
#> • Now that we have all the security flow, let's make the application actually secure, using JWT tokens and secure 
#>   password hashing.
...
## Password Hashing
#> • In the previous examples we were storing the user passwords in plaintext. But now we are going to hash the user
#>   passwords using Passlib and Bcrypt.
#> • Passlib is a great Python package to handle password hashes. It supports many secure hashing algorithms and 
#>   utilities to work with them.
